                ...
                <div class="col-lg-3 col-sm-6">
                    <div class="product mb-0">
                        ...
                        <div class="d-flex justify-content-between">
                            <div>
                                <h3 class="text-3-5 font-weight-medium font-alternative text-transform-none line-height-3 mb-0"><a href="<?= Url::to(['quick-view/index', 'id' => $product->id]) ?>" class="text-color-dark text-color-hover-primary"><?= $product->name ?></a></h3>
                            </div>
                        </div>
