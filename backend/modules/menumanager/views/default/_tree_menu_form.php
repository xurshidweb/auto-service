    ...
    <div class="row">
        ...
        <div class="col-sm-12 col-md-4">
            <?= $form->field($node, 'url_type')->dropDownList([
                ...
                'other' => "Boshqa",
                'news'=>'yangiliklar kategoriyasi',
                'leaders'=>'maqolalar kategoriyasi'

            ], ['prompt' => Html::encode(Yii::t('app', 'url turini tanlang')), 'onchange' => '
                   ...
                   var t =  $(this).val()
                    ...
                    else if (t === "news" || t === "leaders"  || t === "interactive_services"  || t === "departments" ||  t === "page"|| t === "faculty"|| t == "catalog" || t == "sub_catalog" || t == "c-action"){
                        $.ajax({
                            url: menu_url,
                            data: {type:t},
                            type: "get",
        ...
        <div class="col-sm-12 col-md-8">
            <div class="form-group highlight-addon field-tree-url_value">
                ...
                <div id="menu-value">
                    ...
                    <?php
                    if ($node->url_type == 'news')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(Newsid::find()->all(), 'slug', 'title_uz'))->label(false);

                    elseif($node->url_type == 'leaders')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\common\models\AboutCategory::find()->all(), 'slug', 'title'))->label(false);
                    ...
                    elseif ($node->url_type == 'page')
                        echo $form->field($node, 'url_value')->dropdownList(ArrayHelper::map(\common\models\Page::find()->all(),'slug','title_uz'), ['prompt' => "Sahifani tanlang ..."])->label(false);
